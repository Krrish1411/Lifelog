        ...
        >
          ...
          <div className="mt-3 flex flex-col items-center gap-2">
            ...
            <a
              ...
              title="100% Free & Open Source on GitHub (Star / Fork)"
              className="flex h-9 w-9 items-center justify-center rounded-xl border transition-all hover:scale-105 cursor-pointer text-[var(--mut)] hover:text-[var(--text)]"
