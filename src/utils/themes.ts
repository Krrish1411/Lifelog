...
export const DARK_THEMES: DesignerTheme[] = [
  ...
  {
    id: "sepia-dark",
    name: "Warm Sepia Night",
    tag: "Core Free · Terracotta Slate",
    desc: "Cozy warm night parchment with terracotta amber accents and gentle low-strain contrast.",
    mode: "dark",
    isPro: false,
