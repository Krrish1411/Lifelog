                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <a
                        ...
                        className="btn btn-ghost !text-xs !py-1.5 gap-1.5 font-bold"
            ...
            {section(
              ...
              (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <a
                    href="https://github.com/Krrish1411/Lifelog/issues"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col justify-between p-3.5 rounded-xl border transition-all hover:scale-[1.01] hover:border-[var(--accent)]"
                    style={{ borderColor: "var(--line)", background: "var(--bg)" }}
                  >
                    <div>
                      ...
                      <div className="text-[11px] font-semibold mt-1 text-[var(--mut)]">
                        Browse open issues, propose features, and track bug fixes transparently in the open source repo.
                      </div>
                    </div>
                    <div className="mt-3 inline-flex items-center gap-1 text-[11.5px] font-bold text-[var(--accent)]">
              ...
              (
                <div className="flex flex-col gap-3">
                  ...
                  <div className="text-[11px] font-medium leading-relaxed" style={{ color: "var(--mut)" }}>
                    100% Free & Open Source under the MIT License · Zero telemetry · 100% offline-first · Local SQLite WAL & IndexedDB storage · Source: <a href="https://github.com/Krrish1411/Lifelog" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] underline font-bold">github.com/Krrish1411/Lifelog</a>
                  </div>
